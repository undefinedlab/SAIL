        ...
        <ScrollReveal delayMs={80}>
          <div className="max-w-[78ch]">
            <p className="text-[15px] font-light leading-[1.9] text-neutral-700 sm:text-base">
              ...
              action — a treasury transfer, a DAO execution, a regulated trade — it produces an on-chain receipt that
              binds what the agent received, what it committed to, and what it executed.
            </p>
          </div>
        </ScrollReveal>
      </div>
